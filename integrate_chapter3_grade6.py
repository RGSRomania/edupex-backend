#!/usr/bin/env python3
"""
Integrate Chapter 3 Grade 6 Matematica into curriculum_structure.json
"""

import json

def integrate_grade6_chapter3():
    print("=" * 80)
    print("🔧 INTEGRATING CHAPTER 3 GRADE 6 MATEMATICA INTO CURRICULUM")
    print("=" * 80)
    ...
    # Load Chapter 3 Grade 6
    chapter_file = '/Users/mdica/PycharmProjects/EduPex/CHAPTER_3_GRADE6_MATEMATICA.json'
    with open(chapter_file, 'r', encoding='utf-8') as f:
        chapter_3_data = json.load(f)

    print(f"✅ Loaded Chapter 3 Grade 6: {chapter_3_data['name']}")
    print(f"   Lessons: {len(chapter_3_data['lessons'])}")
    ...
    chapter_formatted = {
        "number": str(chapter_3_data["order"]),
        "name": chapter_3_data["name"],
        "description": chapter_3_data.get("description", ""),
        "lectii": []
    }

    # Add all lessons to chapter
    for lesson in chapter_3_data["lessons"]:
        lesson_formatted = {
    ...
    if existing_idx is not None:
        print(f"\n⚠️  Chapter 3 already exists, replacing...")
        chapters_list[existing_idx] = chapter_formatted
    else:
        print(f"\n✅ Adding new Chapter 3")
    ...
    print("\n" + "=" * 80)
    print("✅ CHAPTER 3 GRADE 6 SUCCESSFULLY INTEGRATED!")
    print("=" * 80)

if __name__ == '__main__':
    integrate_grade6_chapter3()
